...
function reload(arr, place) {
    ...
    for(let bgm of arr){
        ...
        modal.classList.add("modal_d")
        
        const start = document.createElement("div")
        start.classList.add("start");
        start.src = goods.image
        start.append(start)
        
        const mhp = document.createElement("div")
        mhp.classList.add("serd")
        
        const mhd = document.createElement("div")
        mhd.classList.add("end")
...
//         <div class="end">
//             <button id="mbu"><img src="./iconmi.png" alt="">Удалить </button>
//             <h2 id="mhd"></h2>
//         </div>
